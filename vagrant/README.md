...
1. Clone WSO2 IS Puppet modules git repository and consider this path as `PUPPET_HOME`:

    ````
    git clone https://github.com/wso2/puppet-is.git
    ````
...
5. Download and copy WSO2 IS distribution to Puppet module under `files` folder:
