...
class is_analytics_worker_master inherits is_analytics_worker_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> is_analytics_worker_master -> files
  */
