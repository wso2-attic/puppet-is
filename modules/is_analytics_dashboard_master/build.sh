...
puppet apply -e "include is_analytics_dashboard_master" --modulepath=${puppet_env}/modules
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/is_analytics_dashboard/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/is_analytics_dashboard_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
