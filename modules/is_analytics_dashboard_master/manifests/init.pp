...
class is_analytics_dashboard_master inherits is_analytics_dashboard_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> is_analytics_dashboard_master -> files
  */
